...
import { generateOAuthURL } from '@/shared/lib/oauth'
...
export default function LoginPage() {
  ...
  const onSubmit = async (data: LoginFormData) => {
    // Early return if already submitting - this prevents multiple calls
    // Check both ref and state for maximum safety
    if (isSubmittingRef.current) {
      console.warn('Login already in progress, ignoring duplicate call')
      return
    }

    // Set flag immediately to prevent any subsequent calls
  ...
  // Wrap handleSubmit to ensure single execution
  const handleFormSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault()
    e.stopPropagation()
    
    // Additional guard at form level
